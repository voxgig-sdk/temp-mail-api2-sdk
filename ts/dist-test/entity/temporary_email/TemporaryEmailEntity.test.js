...
(0, node_test_1.describe)('TemporaryEmailEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'load', 'remove']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'temporary_email.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    let idmap = transform(['temporary_email01', 'temporary_email02', 'temporary_email03', 'temp_mail01', 'temp_mail02', 'temp_mail03', 'temp_mail01', 'temp_mail02', 'temp_mail03', 'message01', 'message02', 'message03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
