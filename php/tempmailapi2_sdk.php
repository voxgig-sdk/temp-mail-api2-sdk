...
class TempMailApi2SDK
{
    ...
    public function TemporaryEmail($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_temporary_email === null) {
                $this->_temporary_email = new TemporaryEmailEntity($this, null);
            }
            return $this->_temporary_email;
        }
        return new TemporaryEmailEntity($this, $data);
    }
