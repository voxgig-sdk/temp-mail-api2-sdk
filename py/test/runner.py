...
class TempMailApi2TestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = TempMailApi2TestRunner.getenv("TEMP_MAIL_API2_TEST_LIVE")
        override = TempMailApi2TestRunner.getenv("TEMP_MAIL_API2_TEST_OVERRIDE")
        ...
        explain = TempMailApi2TestRunner.getenv("TEMP_MAIL_API2_TEST_EXPLAIN")
