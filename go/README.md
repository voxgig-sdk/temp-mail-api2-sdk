...
## Install
```bash
go get github.com/voxgig-sdk/temp-mail-api2-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/temp-mail-api2-sdk=../path/to/github.com/voxgig-sdk/temp-mail-api2-sdk
```
...
```go
// Create
created, _ := client.TemporaryEmail(nil).Create(
...
// Remove
client.TemporaryEmail(nil).Remove(
...
```
github.com/voxgig-sdk/temp-mail-api2-sdk/
...
The root package (`github.com/voxgig-sdk/temp-mail-api2-sdk`) re-exports everything needed
