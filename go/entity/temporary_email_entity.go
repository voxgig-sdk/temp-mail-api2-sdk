...
import (
	...
	vs "github.com/voxgig-sdk/temp-mail-api2-sdk/go/utility/struct"
)
...
func NewTemporaryEmailEntity(client *core.TempMailApi2SDK, entopts map[string]any) *TemporaryEmailEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TemporaryEmailEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TemporaryEmailEntity) Deleted() bool {
	return e.deleted
}
...
func (e *TemporaryEmailEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TemporaryEmailEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
func (e *TemporaryEmailEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
