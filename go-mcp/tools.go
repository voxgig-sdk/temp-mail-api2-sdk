...
func entityFor(client *sdk.TempMailApi2SDK, name string) (sdk.TempMailApi2Entity, error) {
	...
	case "temporary_email":
		return client.TemporaryEmail(nil), nil
